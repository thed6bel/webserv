...
//Compile with : c++ -Wall -Wextra -Werror testsParsing.cpp parsing/*.cpp parsing/serverBlock/*.cpp
...
void    printLocationList(LocationBlock *first)
{
    ...
    while (iterator != NULL)
    {
        ...
        std::cout << "Limitexcept equals "<< iterator->getLimitExcept() << std::endl << std::endl;
...
void    printServerList(ServerBlock *first)
{
    ...
    while (iterator != NULL)
    {
        ...
        std::cout << "Index equals "<< iterator->getIndex() << std::endl;
        std::cout << "Errorcode equals "<< iterator->getErrorPage().errorCode << std::endl;
        std::cout << "Index errorpage equals "<< iterator->getErrorPage().indexErrorPage << std::endl;
